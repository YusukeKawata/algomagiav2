...
**第1幕の縦スライスが通しで遊べる。** `npm run dev`＝タイトル→霧の里(祖父ガロの依頼)→歌の遺構の物理戦×3(徘徊石/番獣)→据炉で覚醒(Qの冷たい声＝最初の裂け目・スキル解禁)→魔石盤の盤戦→旅立ち→第1幕おわり。playwrightで通し確認＝pageエラーゼロ・全シーン描画。
...
- **まだ無い**: フィールド移動(歩けるマップ)／セーブ・ロード（今は1セッション）／名前入力／盤の成長・複数盤・看破・精霊魔法／第2幕以降／アート（プレースホルダ＝差し替え枠）。
